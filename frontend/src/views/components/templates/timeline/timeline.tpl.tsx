...
import { Title } from '~/views/components/atoms/heading';
import { TimelineCard } from '~/views/components/atoms/card';
import { MediaSmallPC, MediaSP } from '~/views/styles/modules';
